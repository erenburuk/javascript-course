...
function checkWinner(avgDolhins, avgKoalas) {
    if (avgDolhins >= avgKoalas * 2) {
        ...
        console.log(`There is no winner. Dolphins and Koalas (${avgDolhins} vs. ${avgKoalas})`);
    }
}
...
friends[2] = 'Jay';
console.log(friends);
//friends = ['Bob', 'Alice']; // this is wrong!
...
friends.push(23);
console.log(friends.includes('Steven')); //es6 includes
...
const jonas = { // this object (jonas) has 5 property
...
const jonas = {
    ...
    getSummary: function () {
        return `${this.firstName} is a ${this.age}-year old ${jonas.job}, and he has ${this.hasDriversLicense ? 'a' : 'no'} driver's license.`;
    }
};
