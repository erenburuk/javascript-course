...
document.querySelector('button').addEventListener('click', function () {
  ...
  for (const [i, row] of rows.entries()) {
    ...
    const newText =
      (a + b[0].toUpperCase() + b.slice(1)).padEnd(20) + '✅'.repeat(i + 1);
    console.log(newText);
  }
});
...
console.log(maskCreditCard(4365436365765734213));
console.log(maskCreditCard('23412515576563452341312'));
...
console.log(new Set('jonasschemmedtmann').size);
...
// Real-world example
const ingredients = [
  // prompt("Let's make pasta! Ingerients 1?"),
  // prompt("Let's make pasta! Ingerients 2?"),
  // prompt("Let's make pasta! Ingerients 3?"),
];
